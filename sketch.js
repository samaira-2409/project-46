...
function draw(){
  ...
  //pacman.bounceOff(wall54);
  //pacman.bounceOff(wall52);
  //pacman.bounceOff(wall53);
  ...
  pacman.isTouching(fruit2)  || pacman.isTouching(fruit3) ){
...
function spawnGhosts(){
  if(frameCount%60===0){
    ghost = createSprite((random(35,550),random(35,550),random(10,20),random(10,20)));
    ghost.velocityX = random(-3,3);
    ghost.velocityY = random(-3,3);
    var rand = Math.round(random(1,3))
    /*switch(rand){
      case 1 : ghost.addAnimation(ghost1downImg);
      break;
      case 2 : ghost.addAnimation(ghost2downImg);
      break;
      case 3 : ghost.addAnimation(ghost3downImg);
      break;
      default : break;
    }*/
